...
import se.johanmagnusson.android.sunshine.data.WeatherDbHelper;
...
public class WeatherProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
                return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE;  //only returns one item
            case WEATHER_WITH_LOCATION:
                return WeatherContract.WeatherEntry.CONTENT_TYPE;       //the others return several(dir)
            case WEATHER:
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if(selection == null) selection = "1";  //deletes all and get a return value
