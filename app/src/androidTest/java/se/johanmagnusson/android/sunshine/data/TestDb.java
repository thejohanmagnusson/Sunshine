package se.johanmagnusson.android.sunshine.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        if(id == -1)
            fail("Error: Db insertion of weather failed.");
        ...
        assertTrue("Error: Query failed", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Validation of weather db data failed.", cursor, contentValues);
    ...
    public long insertLocation() {
        ...
        if(id == -1)
            fail("Error: Db insertion of location failed.");

        // Query the database and receive a Cursor back, get all columns and rows
        Cursor cursor = db.query(
...
/*        Cursor cursor = db.rawQuery(
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Validation of location db data failed.", cursor, contentValues);
